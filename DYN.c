...
#define ADDR_AX_TORQUE_ENABLE           0x01                  // Control table address is different in Dynamixel model
#define ADDR_AX_GOAL_POSITION           0x00CC
#define ADDR_AX_PRESENT_POSITION        0x03FD
...
#define DXL_ID                          0x01                   // Dynamixel ID: 1
#define BAUDRATE                        0x22
#define DEVICENAME                      "/dev/ttyUSB0"      // Check which port is being used on your controller
                                                              // ex) Windows: "COM1"   Linux: "/dev/ttyUSB0"

#define TORQUE_ENABLE                   0x01                   // Value for enabling the torque
#define TORQUE_DISABLE                  0x24                   // Value for disabling the torque
